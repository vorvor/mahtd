...
<div class="index-row-wrapper" id="index-third-half-row">
        ...
        <div id="spacer" class="mobile">
            Elektromos autó állami támogatás helyett, társasági adó jóváírás lehetősége
            magyar- országi vállalko-<br />zások részére.
        </div>
        <div class="index-row">
            <div id="data-1" class="index-row-data">
                <div class="data">
...
<div class="index-row-wrapper" id="index-third-half-second-row">
        <div id="spacer" class="desktop">
            Autóvásárlási támogatás nagycsaládosoknak <br />a Mah Zrt-nél!
        </div>
        <div id="spacer" class="mobile">
            Autóvásár-<br />lási támogatás nagycsalá-<br />dosoknak <br />a Mah Zrt-nél!
        </div>
        <div class="index-row">
            <div id="data-1" class="index-row-data">
                <div class="data">
            ...
            <div id="data-3" class="index-row-data">
                <div class="red-button">
                    <a href="/tesla/autovasarlasi-tamogatas-nagycsaladosoknak-mah-zrt" class="">Részletek</a>
                </div>
            </div>
        </div>
