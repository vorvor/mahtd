 ...
 */
function tesla_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['tesla_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('tesla sample setting'),
  '#default_value' => theme_get_setting('tesla_example'),
